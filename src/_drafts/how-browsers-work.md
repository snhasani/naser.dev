...
![StatCounter-browser-IR-quarterly-q4-2015-bar](/assets/images/content/2015/12/StatCounter-browser-IR-quarterly-q4-2015-bar.jpg)
{% endfigure %}
...
![فرآیند اصلی رندر در موتور Gecko موزیلا](/assets/images/content/2015/12/firefox-Gecko-rendering-engine-main-flow.png)
{% endfigure %}
...
![نمودار چرخه‌ی تجزیه‌ی HTML](/assets/images/content/2015/12/html-parsing-flowchart.png)
{% endfigure %}
...
![layout-rect-calculate-the-position-size](/assets/images/content/2015/12/layout-rect-calculate-the-position-size.jpg)
{% endfigure %}
...
فرآیند پردازشی مربود به صفحه بندی به صورت بازگشتی است. این فرآیند از شی رندر ریشه که به تگ «html» اشاره می‌کند، شروع می‌شود و به صورت بازگشتی با پیمایش بعضی یا تمامی فریم‌های زیر مجموعه‌ای خود و محاسبه اطلاعات هندسی هر کدام از فریم‌ها که نیاز بود ادامه پیدا می‌کند. تمامی فریم‌ها دارای یک متد `layout` یا `reflow` هستند، که در صورت نیاز این وظیفه‌ی والد است که متد صفحه بندی فرزندانش را فراخوانی کند. در ویدیوی زیر به راحتی می‌توانید فرآیند صفحه بندی در مرورگر فایرفاکس را مشاهده کنید.

{% video /assets/images/content/2015/12/gecko-layout-reflow-video.mp4 %}
